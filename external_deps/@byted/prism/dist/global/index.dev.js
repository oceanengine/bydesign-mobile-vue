var Prism = (function (exports, d3, d3hsv, d3cam02, d3hsluv) {
  'use strict';
  ...
  ***************************************************************************** */
  ...
  function querySequence(space, backgroundColor, keyColors, contrastRatioList) {
      ...
      ];
      {
          ...
          // start color
          const interpolate = interpolator(translator(d3.rgb(dark ? "#000000" : "#ffffff")), finalKeyColors[0]);
          const sequenceHex = [];
          const sequenceRatio = [];
          Array(fragments)
              .fill(0)
  ...
  exports.CONTRAST_RATIO_MAX = CONTRAST_RATIO_MAX;
  exports.CONTRAST_RATIO_MIN = CONTRAST_RATIO_MIN;
  exports.MESSAGE_TYPE_HANDLER_MAP = MESSAGE_TYPE_HANDLER_MAP;
  exports.RGB_MAX = RGB_MAX;
  exports.RGB_MIN = RGB_MIN;
  exports.asyncQueue = asyncQueue;
  exports.contrastRatio = contrastRatio;
  exports.createColorTranslator = createColorTranslator;
  exports.curveAdobeSpectrum = curveAdobeSpectrum;
  exports.curveAntD = curveAntD;
  exports.curveByDesign = curveByDesign;
  exports.curveFirefoxPhoton = curveFirefoxPhoton;
  exports.curveFunctionMap = curveFunctionMap;
  exports.curveGoogleMaterial = curveGoogleMaterial;
  exports.curveMicrosoftFluent = curveMicrosoftFluent;
  exports.curveNormalizeMap = curveNormalizeMap;
  exports.getClosestIndex = getClosestIndex;
  exports.getRelatedLuminanceByContrastRatio = getRelatedLuminanceByContrastRatio;
  exports.getSrgbFromNumber = getSrgbFromNumber;
  exports.getYSeries = getYSeries;
  exports.grayScale = grayScale;
  exports.init = init;
  exports.query = query;
  exports.queryClosest = queryClosest;
  exports.querySequence = querySequence;
  exports.querySeries = querySeries;
  exports.relatedLuminance = relatedLuminance;
  exports.standardToLinear = standardToLinear;
  exports.toolkitMap = toolkitMap;
  exports.translatorMap = translatorMap;
