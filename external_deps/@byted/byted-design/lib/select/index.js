...
exports.default = (_name$directives$prov = {
  name: _base.CSS_PREFIX + 'select',
  ...
  components: {
    BytedTag: _tag2.default,
    BytedIcon: _icon2.default,
    BytedInput: _input2.default,
    BytedPopper: _popper2.default
  }

}, _defineProperty(_name$directives$prov, 'directives', { clickoutside: _clickoutside2.default }), _defineProperty(_name$directives$prov, 'mixins', [_emitter2.default, _locale2.default]), _defineProperty(_name$directives$prov, 'props', {
  // 是否多选
  multiple: {
    type: Boolean,
    default: false
  ...
  size: {
    ...
    validator: function validator(value) {
      return (0, _helper.isOneOf)(value, ['md', 'small', 'large', 'xs', 'sm', 'lg', 'xl']);
    }
  },
  // 搜索条件无匹配时显示的文字
  noMatchText: {
  ...
  align: {
    ...
    default: 'left',
    validator: function validator(value) {
      return (0, _helper.isOneOf)(value, ['left', 'center', 'right']);
    }
  },
  popperOptions: {
    type: Object,
...
}), _defineProperty(_name$directives$prov, 'data', function data() {
  return {
    // popper show
    optionShow: false,
    // options array
    ...
    hovering: false,
    selected: [],
    // 该变量提供给业务方二次开发使用，用于渲染显示label标签，类型为function
    renderLabel: null
  };
}), _defineProperty(_name$directives$prov, 'computed', {
  _placeholder: function _placeholder() {
    return this.placeholder || this.t(_base.LOCALE_PREFIX + '.select.placeholder');
  },
  _filterPlaceholder: function _filterPlaceholder() {
    return this.filterPlaceholder || this.t(_base.LOCALE_PREFIX + '.select.filterPlaceholder');
  },
  _noDataText: function _noDataText() {
    return this.noDataText || this.t(_base.LOCALE_PREFIX + '.select.noDataText');
  },
  _noMatchText: function _noMatchText() {
    return this.noMatchText || this.t(_base.LOCALE_PREFIX + '.select.noMatchText');
  },
  _hasSelect: function _hasSelect() {
    if (this.selected.length > 99) {
      return '99+';
    }
    return this.selected.length;
  },
  baseClass: function baseClass() {
    var baseClass = _base.CSS_PREFIX + 'select';
    ...
    if (!this.multiple) {
      ...
      classArr.push(baseClass + '-' + this.multipleSize);
    }
    if (this.plain) {
  ...
  wrapperClass: function wrapperClass() {
    return {
      'active': this.optionShow && !this.collapseTags
    };
  },
  ...
  isMultipleWrapperShow: function isMultipleWrapperShow() {
    return this.multiple && this.selected.length && (!this.collapseTags || this.optionShow);
  },
  isMultipeCollapseTagsShow: function isMultipeCollapseTagsShow() {
    return this.multiple && this.collapseTags && this.selected.length && !this.optionShow;
  },
  ...
  collapseTagsList: function collapseTagsList() {
    ...
    // label length width
    var labelWidth = Math.max(26, (0, _measureText.getMeasureTextWidth)(this.selected.length) + 12);
    // 容器总宽度 - paddingLeft - paddingRight - border-label
    var wrapperWidth = this.popperRefWidth - 8 - 32 - 2 - labelWidth;
    var currentWidth = 0;
    var list = [];
    var i = 0;
    ...
    while (currentWidth < wrapperWidth && i < this.selected.length) {
      // border + marginLeft
      var width = 2 + 4 + tagPaddingLeft + (0, _measureText.getMeasureTextWidth)(this.getSelectedLabel(this.selected[i]), { fontSize: fontSize }) + tagPaddingRight;
      // const width = 2 + 4 + tagPaddingLeft + this.getSelectedLabel(this.selected[i]).length * fontSize + tagPaddingRight;
    ...
    return list.length ? list : [this.selected[0]];
  },
  showClear: function showClear() {
    var hasValue = void 0;
    if (this.multiple) {
      hasValue = Array.isArray(this.value) && this.value.length > 0;
    } else {
      hasValue = this.value !== undefined && this.value !== null && this.value !== '';
    }
    return this.clearable && !this.disabled && hasValue && this.hovering;
  },

  // 记录过滤项的个数
  filteredOptionsCount: function filteredOptionsCount() {
    return this.optionsArr.filter(function (option) {
      return option.visible;
    }).length;
  }
}), _defineProperty(_name$directives$prov, 'watch', {
  ...
  filterLabel: function filterLabel(val) {
    this.$emit('change:filter', val);
  }
}), _defineProperty(_name$directives$prov, 'created', function created() {
  if (this.multiple && !Array.isArray(this.value)) {
    console.error('SELECT ERROR: 请设置value值为数组');
  }
}), _defineProperty(_name$directives$prov, 'mounted', function mounted() {
  var _this = this;
  ...
  this.$nextTick(function () {
    ...
    _this.popperRef = _this.$refs.popperRef;
    _this.popperRefRo = new _resizeObserverPolyfill2.default(function () {
      _this.popperRefWidth = _this.$refs.popperRef && _this.$refs.popperRef.clientWidth || 0;
    });
  ...
  // 监测DOM变化，更新popper
  this.bindEvent();
}), _defineProperty(_name$directives$prov, 'beforeDestroy', function beforeDestroy() {
  try {
    if (this.RO) {
...
}), _defineProperty(_name$directives$prov, 'methods', {
  ...
  bindEvent: function bindEvent() {
    ...
    if (this.multiple) {
      this.$nextTick(function () {
        if (!_this2.$refs.multiple) {
          return;
        }
        _this2.RO = new _resizeObserverPolyfill2.default(_this2.handleResize);
        _this2.RO.observe(_this2.$refs.multiple);
      });
    }
  },
  ...
  changePoperRef: function changePoperRef() {
    if (this.multiple && this.collapseTags && this.selected.length && this.$refs.multiple) {
  ...
  handleWrapMouseEnter: function handleWrapMouseEnter() {
    this.hovering = true;
  },
  handleWrapMouseLeave: function handleWrapMouseLeave() {
    this.hovering = false;
  },
  ...
  clickoutsideHandle: function clickoutsideHandle(e) {
    ...
    while (parent && !(0, _dom.hasClass)(parent, 'bui-select-popper') && parentId !== this.selectMultipleCollapseWrapperId) {
  ...
  setFilterFocus: function setFilterFocus() {
    this.filterable && this.$refs.filter && this.$refs.filter.focus();
  },

  // 销毁option
  handleOptionDestory: function handleOptionDestory(option) {
    // option销毁后，修改option的数组
    var index = this.optionsArr.indexOf(option);
    if (index > -1) {
  ...
  handleOptionClick: function handleOptionClick(option) {
    ...
    if (this.multiple) {
      ...
      optionIndex > -1 ? value.splice(optionIndex, 1) : value.push(option.value);
      this.$emit('input', value);
      this.emitChange(value);
    } else {
      value = [option.value];
  ...
  // 比较值是否完全相等
  valueEquals: function valueEquals(a, b) {
    if (a === b) return true;
  ...
  setSelected: function setSelected() {
    ...
    var selected = [];
    var curValue = this.multiple ? this.value || [] : [this.value];

    curValue.forEach(function (value, index) {
      var option = _this4.optionsArr.filter(function (item) {
        return item.value === value;
      });
      var oldOption = oldSelected.filter(function (item) {
        return item.value === value;
      });
      // 外部返回label值，暂时支持基本类型，option > old option, 兜底label显示value
      if (_this4.renderLabel && typeof _this4.renderLabel === 'function') {
        selected.push({ value: value, currentLabel: _this4.renderLabel(value) });
      } else if (option.length) {
        selected = selected.concat(option);
      } else if (oldOption.length) {
        selected = selected.concat(oldOption);
      } else if (value !== '') {
        selected.push({ value: value, currentLabel: value });
      }
      if (selected[index]) selected[index]['key'] = _utils2.default.getRandomStr(6);
    });
  ...
  // remove tag
  handleTagRemove: function handleTagRemove(curVal) {
    var value = this.value.slice();
    value.splice(value.indexOf(curVal), 1);
    this.$emit('input', value);
    this.emitChange(value);
    this.dispatch(_base.CSS_PREFIX + 'form-item', 'bui.form.change', value);
  },
  ...
  handleQueryChange: function handleQueryChange(query) {
    ...
    if (this.filterMethod && typeof this.filterMethod === 'function') {
      ...
      // 初始化过滤选项值
      this.broadcast(_base.CSS_PREFIX + 'option', 'queryChange', query.trim());
    }
  },
  ...
  handleFilterClear: function handleFilterClear(value) {
    this.handleQueryChange(value);
  },
...
exports.default = {
  name: _base.CSS_PREFIX + 'optgroup',
  ...
  computed: {
    baseClass: function baseClass() {
      var baseCls = _base.CSS_PREFIX + 'optgroup';
...
_select2.default.install = function (Vue) {
  ...
  Vue.component(_optgroup2.default.name, _optgroup2.default);
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_select_vue__ = __webpack_require__(202);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_84932b44_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_select_vue__ = __webpack_require__(427);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(0);
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_84932b44_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_select_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_84932b44_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_select_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return render; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return staticRenderFns; });
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"clickoutside",rawName:"v-clickoutside",value:(_vm.clickoutsideHandle),expression:"clickoutsideHandle"}],class:_vm.baseClass},[_c('div',{ref:"popperRef",staticClass:"bui-select-wrapper",class:_vm.wrapperClass,on:{"click":_vm.handleSelectClick,"mouseenter":_vm.handleWrapMouseEnter,"mouseleave":_vm.handleWrapMouseLeave}},[_vm._t("input",[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.isMultipleWrapperShow),expression:"isMultipleWrapperShow"}],ref:"multiple",staticClass:"bui-select-wrapper-multiple",class:_vm.multipleClass},_vm._l((_vm.selected),function(item){return _c('byted-tag',{key:item.key,staticClass:"bui-select-tag",attrs:{"disabled":_vm.disabled,"plain":_vm.disabled,"size":_vm.multipleSize,"type":"default","closable":""},on:{"close":function($event){return _vm.handleTagRemove(item.value)}}},[_vm._v("\n          "+_vm._s(_vm.getSelectedLabel(item))+"\n        ")])}),1),_vm._v(" "),(_vm.isMultipeCollapseTagsShow)?_c('div',{staticClass:"bui-select-wrapper-multiple bui-select-wrapper-multiple-collapse",attrs:{"data-id":_vm.selectMultipleCollapseWrapperId}},[_vm._l((_vm.collapseTagsList),function(tag,index){return _c('byted-tag',{key:index,staticClass:"bui-select-tag",attrs:{"disabled":_vm.disabled,"plain":_vm.disabled,"size":_vm.multipleSize,"closable":""},on:{"close":function($event){return _vm.handleTagRemove(tag.value)}}},[_vm._v("\n          "+_vm._s(_vm.getSelectedLabel(tag))+"\n        ")])}),_vm._v(" "),_c('span',{staticClass:"bui-selected-label"},[_vm._v("\n          "+_vm._s(_vm._hasSelect)+"\n        ")])],2):_vm._e(),_vm._v(" "),(_vm.isInputShow)?_c('input',{ref:"input",staticClass:"bui-input",style:(_vm.inputStyle),attrs:{"placeholder":_vm._placeholder,"disabled":_vm.disabled,"readonly":""},domProps:{"value":_vm.getSelectedLabel(_vm.selected[0])},on:{"blur":_vm.handleInputBlur,"focus":_vm.handleInputFocus}}):_vm._e(),_vm._v(" "),(_vm.plain)?_c('div',{staticClass:"bui-select-wrapper-plain",style:(_vm.inputStyle)},[_c('span',{staticClass:"bui-input"},[_vm._v(_vm._s(_vm.getSelectedLabel(_vm.selected[0]) || _vm._placeholder))]),_vm._v(" "),_c('byted-icon',{staticClass:"bui-select-icon-plain",class:{open:_vm.optionShow},attrs:{"name":"angle-down"},on:{"click":function($event){$event.stopPropagation();return _vm.handleIconClick($event)}}})],1):_vm._e()]),_vm._v(" "),_c('byted-icon',{directives:[{name:"show",rawName:"v-show",value:(!_vm.plain && !_vm.showClear),expression:"!plain && !showClear"}],staticClass:"bui-select-icon",class:{open:_vm.optionShow},attrs:{"name":"angle-down"},on:{"click":function($event){$event.stopPropagation();return _vm.handleIconClick($event)}}}),_vm._v(" "),(!_vm.plain && _vm.showClear)?_c('byted-icon',{staticClass:"bui-select-icon bui-select-clear-icon",attrs:{"name":"close-circle"},on:{"click":function($event){$event.stopPropagation();return _vm.handleClearClick($event)}}}):_vm._e()],2),_vm._v(" "),_c('byted-popper',{directives:[{name:"show",rawName:"v-show",value:(_vm.optionShow),expression:"optionShow"}],ref:"popper",staticClass:"bui-select-popper",class:_vm.popperClass,attrs:{"reference":_vm.popperRef,"append-to-body":_vm.transfer,"popper-options":_vm.popperOptions,"placement":"bottom-start"}},[_c('div',{staticClass:"bui-select-option"},[(_vm.filterable)?_c('div',{staticClass:"bui-option-filter"},[_c('byted-input',{ref:"filter",attrs:{"size":_vm.size,"validate-event":false,"placeholder":_vm._filterPlaceholder,"prefix":"search","clearable":""},on:{"input":_vm.handlefilterInput,"clear":_vm.handleFilterClear},model:{value:(_vm.filterLabel),callback:function ($$v) {_vm.filterLabel=$$v},expression:"filterLabel"}},[_c('template',{slot:"append"},[_vm._t("filter-append")],2)],2)],1):_vm._e(),_vm._v(" "),_c('div',{staticClass:"bui-select-option-wrapper"},[_vm._t("default")],2),_vm._v(" "),(_vm.optionsArr.length && _vm.filteredOptionsCount <= 0)?_c('div',{staticClass:"bui-option-match-none"},[_c('byted-icon',{attrs:{"name":"empty"}}),_vm._v("\n        "+_vm._s(_vm._noMatchText)+"\n      ")],1):_vm._e(),_vm._v(" "),(!_vm.optionsArr.length)?[_vm._t("empty",[_c('div',{staticClass:"bui-option-match-none"},[_c('byted-icon',{attrs:{"name":"empty"}}),_vm._v("\n            "+_vm._s(_vm._noDataText)+"\n          ")],1)])]:_vm._e(),_vm._v(" "),_vm._t("footer")],2)])],1)}
var staticRenderFns = []
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_optgroup_vue__ = __webpack_require__(203);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_optgroup_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_optgroup_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_optgroup_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_optgroup_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_dc182408_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_optgroup_vue__ = __webpack_require__(429);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(0);
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_optgroup_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_dc182408_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_optgroup_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_dc182408_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_optgroup_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return render; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return staticRenderFns; });
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:_vm.baseClass},[_c('p',{staticClass:"bui-optgroup-label"},[_vm._v(_vm._s(_vm.label))]),_vm._v(" "),_vm._t("default")],2)}
var staticRenderFns = []
...
exports.default = {
  ...
  methods: {
    handleClick: function handleClick() {
      ...
      this.select.handleOptionClick(this); // 调用select上的函数
    },
