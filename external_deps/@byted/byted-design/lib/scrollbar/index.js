...
var _scrollbar = __webpack_require__(423);
...
var _perfectScrollbarMin = __webpack_require__(424);

var _perfectScrollbarMin2 = _interopRequireDefault(_perfectScrollbarMin);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

Vue.directive('bui-scrollbar', {
  inserted: function inserted(el, binding, vnode) {
    var expression = binding.expression;
    var ps = new _perfectScrollbarMin2.default(el, {
      wheelPropagation: true
    });
    if (expression) {
      vnode.context[expression] = ps;
    }
  }
});
