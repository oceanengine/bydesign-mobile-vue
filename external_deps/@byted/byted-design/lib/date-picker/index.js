...
exports.default = {
  name: _base.CSS_PREFIX + 'date-picker',
  components: {
  ...
  methods: {
    handleInputClick: function handleInputClick() {
      ...
      this.handlePickerPanelShow(!this.panelShow);
    },
    handleInputChange: function handleInputChange(value) {
      var date = this.parse(value, this.format, true);
      var disabled = this.disabledDate ? this.disabledDate(date) : false;
      if (this.isValid(date) && !this.isSame(date, this.innerValue[0] || null) && !disabled) {
...
// TODO 记录
// 组件间通信涉及到三层，inject、provide使用规范需要明确
// mixins 使用问题，什么时候应该放到mixin内
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_19567497_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_date_picker_vue__ = __webpack_require__(303);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(0);
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_19567497_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_date_picker_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_19567497_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_date_picker_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return render; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return staticRenderFns; });
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"clickoutside",rawName:"v-clickoutside.capture",value:(_vm.handleClickOutside),expression:"handleClickOutside",modifiers:{"capture":true}}],class:_vm.baseClass},[_c('byted-input',{ref:"popperRef",attrs:{"size":_vm.size,"placeholder":_vm._placeholder,"value":_vm.innerValueFormat,"validate-event":false,"readonly":!_vm.editable,"disabled":_vm.disabled,"clearable":_vm.clearable},on:{"input":_vm.handleInputChange,"clear":_vm.handleClear,"click":_vm.handleInputClick}},[_c('template',{slot:"suffix"},[_c('byted-icon',{staticClass:"bui-date-picker-icon",attrs:{"name":"calendar"},on:{"click":_vm.handleInputClick}})],1)],2),_vm._v(" "),_c('byted-popper',{directives:[{name:"show",rawName:"v-show",value:(_vm.panelShow),expression:"panelShow"}],staticClass:"bui-picker-popper",attrs:{"reference":_vm.popperRef,"append-to-body":_vm.transfer,"popper-options":_vm.popperOptions},on:{"click":function($event){$event.stopPropagation();$event.preventDefault();}}},[_c('div',{staticClass:"bui-picker-popper-content"},[(_vm.isShortcutsShow)?_c('div',{staticClass:"bui-picker-shortcuts"},[_vm._t("shortcuts",[(_vm.shortcuts.length)?_c('shortcuts',{attrs:{"value":_vm.shortcuts},on:{"select":_vm.handleShortcutSelect,"visible-change":_vm.handlePickerPanelShow}}):_vm._e()])],2):_vm._e(),_vm._v(" "),(_vm.panelShow)?_c(_vm.panelName,{tag:"component",attrs:{"panel-show":_vm.panelShow,"type":_vm.type,"format":_vm.format,"value":_vm.innerValue,"value-format":_vm.valueFormat,"view-date":_vm.viewDate,"hover-value":_vm.hoverValue,"default-date":_vm.defaultDate,"disabled-date":_vm.disabledDate,"default-time":_vm.defaultTime,"disabled-time":_vm.disabledTime,"multiple":_vm.multiple,"date-render":_vm.dateRender},on:{"select":_vm.handlePickerInnerValueChange,"view-date-change":_vm.handlePickerViewDateChange,"panel-change":_vm.handlePanelChange,"hover-value-change":_vm.handleHoverValueChange}}):_vm._e()],1),_vm._v(" "),(_vm.isPanelExtraFooterShow)?_c('div',{staticClass:"bui-picker-popper-footer-extra"},[_vm._t("panelExtraFooter")],2):_vm._e(),_vm._v(" "),(_vm.isFooterBtnShow && _vm.panelName === _vm.PANEL_NAME_MAP[_vm.type])?_c('div',{staticClass:"bui-picker-popper-footer"},[_c('byted-button',{attrs:{"disabled":_vm.isConfirmBtnDisabled,"type":"primary","size":"xs"},on:{"click":_vm.handleConfirm}},[_vm._v(_vm._s(_vm._okText))])],1):_vm._e()])],1)}
var staticRenderFns = []
