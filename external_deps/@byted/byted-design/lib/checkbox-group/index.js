...
exports.default = {
  name: _base.CSS_PREFIX + 'checkbox-group',
  ...
  computed: {
    baseClass: function baseClass() {
      var classArr = [_base.CSS_PREFIX + 'checkbox-group'];
      if (this.isCheckboxButton) {
  ...
  mounted: function mounted() {
    if (this.$children[0] && this.$children[0].$options.name === _base.CSS_PREFIX + 'checkbox-button') {
      this.isCheckboxButton = true;
    }
  },
  created: function created() {
    this.$on('bui.checkbox.change', this.checkboxChange);
  },
  ...
  methods: {
    checkboxChange: function checkboxChange(_ref) {
      ...
      checked ? arr.push(val) : arr.splice(arr.indexOf(val), 1);
      this.$emit('input', arr);
      this.$emit('change', arr);
      this.dispatch(_base.CSS_PREFIX + 'form-item', 'bui.form.change', [arr]);
    }
  }
};
...
var _checkboxGroup = __webpack_require__(273);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5578ddaa_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_checkbox_group_vue__ = __webpack_require__(274);
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5578ddaa_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_checkbox_group_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5578ddaa_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_checkbox_group_vue__["b" /* staticRenderFns */],
