<template>
  <div class="demo swipe-cell">
    ...
    <demo-title :title="t('name')" style="padding-left: 0.8rem">
      <byted-icon-hand-drag theme="outline" size="20" fill="#333" />
    </demo-title>
...
<script>
import { BytedIconHandDrag } from '@byte-design/vue-icons';
